...
type EventsForWeekProvider interface {
	EventsForWeek(userId int, eventDate string) (*[]domain.ReqParameters, error)
}

func New(lg *slog.Logger, eventsForWeekProv EventsForWeekProvider) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// получение события
		resp, err := eventsForWeekProv.EventsForWeek(eventData.UserId, eventData.Date)
		if err != nil {
